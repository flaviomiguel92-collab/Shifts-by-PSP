...
const styles = StyleSheet.create({
  ...
  totalPillText: { color: '#10B981', fontWeight: '500', fontSize: 13 },
  scroll: { flex: 1 },
  scrollContent: {
  ...
  xlsxBtnText: { color: '#10B981', fontSize: 11, fontWeight: '500' },
  searchRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  kpiDivider: { width: 1, backgroundColor: 'rgba(148,163,184,0.18)', marginVertical: 4 },
  kpiLabel: { color: '#475569', fontSize: 11, marginBottom: 4, textAlign: 'center' },
  kpiValue: { fontSize: 22, fontWeight: '500', color: '#F1F5F9', textAlign: 'center' },
  ...
  entryLeft: { flex: 1 },
  entryName: { color: '#E2E8F0', fontWeight: '500', fontSize: 14, marginBottom: 4 },
  ...
  monthRowTotal: { color: '#10B981', fontWeight: '500', fontSize: 13, width: 88, textAlign: 'right' },
});
