...
from routers import auth, cycles, gratifications, misc, occurrences, shift_types, shifts, stats
...
for _router in (auth, shifts, cycles, gratifications, stats, occurrences, shift_types, misc):
