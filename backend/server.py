...
if not start_time and shift_data.shift_type in SHIFT_TIMES:
    start_time = SHIFT_TIMES[shift_data.shift_type]["start"]
if not end_time and shift_data.shift_type in SHIFT_TIMES:
    end_time = SHIFT_TIMES[shift_data.shift_type]["end"]
...
for shift_item in bulk_data.shifts:
    ...
    if not start_time and shift_item.shift_type in SHIFT_TIMES:
        start_time = SHIFT_TIMES[shift_item.shift_type]["start"]
    if not end_time and shift_item.shift_type in SHIFT_TIMES:
        end_time = SHIFT_TIMES[shift_item.shift_type]["end"]
...
# ==================== OCCURRENCE ENDPOINTS (SEM AUTENTICAÇÃO) ====================
